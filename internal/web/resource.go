...
import (
	...
	tmpl "github.com/accuknox/rinc/view/resource"
...
func (s Srv) ResourceUtilization(c echo.Context) error {
	id := c.Param("id")
	title := fmt.Sprintf("%s - Resource Utilization | AccuKnox Reports", id)
