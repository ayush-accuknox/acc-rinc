...
func Navbar(roundedBottom bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var2 = []any{
			...
			templ.KV("rounded-b-lg", roundedBottom),
			templ.KV("shadow-lg", roundedBottom),
			templ.KV("border-b-2", roundedBottom),
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/partial/navbar.templ`, Line: 1, Col: 0}
		}
